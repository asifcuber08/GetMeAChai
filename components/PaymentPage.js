                ...
                <div className="payment flex gap-3 w-[80%] mt-11 flex-col md:flex-row">
                    ...
                    <div className="makePayment w-full md:w-1/2 bg-slate-900 rounded-lg text-white px-2 md:p-10">
                        ...
                        <div className='flex gap-2 flex-col'>
                            ...
                            <button onClick={() => pay(Number.parseInt(paymentform.amount) * 100)} type="button" className="text-white cursor-pointer bg-gradient-to-br from-purple-900 to-blue-900 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 disabled:bg-slate-600 disabled:from-purple-100" disabled={paymentform.name?.length < 3 || paymentform.message?.length < 4 || paymentform.amount?.length<1}>Pay</button>
